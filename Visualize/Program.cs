...
//using var game = new Visualize.Core(BuildingGen.Program.GenerateFromTest2DField((20, 20), 0));
using var game = new Visualize.Core(BuildingGen.Program.DivideGeneratedField("InputFields/generatedField2D.json"));
